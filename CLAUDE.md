...
Currently working: DF-03 next — Uniform flag component (fixed box, capped width, vertical-align, subtle border) replacing fixed-height/auto-width render across WC strip + standings + knockouts + league fixtures.py.
